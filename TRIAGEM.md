...
Eu acredito que tenha encontrado soluções lógicas para todos os casos, não encontrei nenhuma dificuldade em minha análise. A única barreira foi entender o que eu tenho acesso e o que posso executar.   
